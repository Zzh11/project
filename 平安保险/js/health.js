...
/*dbox的循环*/
    for(var i=1;i<47;i++) {
        ...
        var updown2lis=$("updown2").querySelectorAll("li");
        var updown3lis=$("updown3").querySelectorAll("li");
    ...
    /* 少儿健康的上下页*/
        ...
        (function(j){
            ...
            {
                case 0:
                    updown2lis[j].onclick=function(){
                        if( updown2lis[2].style.backgroundColor="#FF6633"){
                            updown2lis[1].onclick();
                        }
                    }
                    break;
                case 1:
                    updown2lis[j].onclick=function(){
                        updown2lis[0].style.display="none";
                        updown2lis[3].style.display="block";
                        dboxs.style.height="1200px";
                        $("content").style.height="1450px";
                        $("page3").style.height="1200px";
                        for (var i=1;i<3;i++) {
                            if(i == j){
                                updown2lis[j].style.backgroundColor="#FF6633";
                                updown2lis[j].style.color="#FFFFFF";
                                $("page2up"+ i).style.display="block";
                            } else {
                                updown2lis[i].style.backgroundColor="#FFFFFF";
                                updown2lis[i].style.color="black";
                                $("page2up"+ i).style.display="none";
                            }
                        }
                    }
                    break;
                case 2:
                    updown2lis[j].onclick=function(){
                        updown2lis[3].style.display="none";
                        updown2lis[0].style.display="block";
                        dboxs.style.height="920px";
                        $("content").style.height="1050px";
                        $("page3").style.height="920px";
                        for (var i=1;i<3;i++) {
                            if(i == j){
                                updown2lis[j].style.backgroundColor="#FF6633";
                                updown2lis[j].style.color="#FFFFFF";
                ...
                case 3:
                    updown2lis[j].onclick=function(){
                        if( updown2lis[1].style.backgroundColor="#FF6633"){
                            updown2lis[2].onclick();
                        }
                    }
                    break;
            }
    ...
    for(var j=0;j<4;j++){
        (function(j){
            ...
            {
                case 0:
                    updown3lis[j].onclick=function(){
                        if( updown3lis[2].style.backgroundColor="#FF6633"){
                            updown3lis[1].onclick();
                        }
                    }
                    break;
                case 1:
                    updown3lis[j].onclick=function(){
                        updown3lis[0].style.display="none";
                        updown3lis[3].style.display="block";
                        dboxs.style.height="1200px";
                        $("content").style.height="1450px";
                        $("page2").style.height="1200px";
                        for (var i=1;i<3;i++) {
                            if(i == j){
                                updown3lis[j].style.backgroundColor="#FF6633";
                                updown3lis[j].style.color="#FFFFFF";
                                $("page3up"+ i).style.display="block";
                            } else {
                                updown3lis[i].style.backgroundColor="#FFFFFF";
                                updown3lis[i].style.color="black";
                                $("page3up"+ i).style.display="none";
                            }
                        }
                    }
                    break;
                case 2:
                    updown3lis[j].onclick=function(){
                        updown3lis[3].style.display="none";
                        updown3lis[0].style.display="block";
                        dboxs.style.height="920px";
                        $("content").style.height="1050px";
                        $("page2").style.height="920px";
                        for (var i=1;i<3;i++) {
                            if(i == j){
                                updown3lis[j].style.backgroundColor="#FF6633";
                                updown3lis[j].style.color="#FFFFFF";
                ...
                case 3:
                    updown3lis[j].onclick=function(){
                        if( updown3lis[1].style.backgroundColor="#FF6633"){
                            updown3lis[2].onclick();
                        }
                    }
                    break;
            }
